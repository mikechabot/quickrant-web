...
app.controller('MainController', ['$scope', '$timeout', 'QR_DATA', 'QR_CONST', 'QuickrantFactory', 'DialogService', function ($scope, $timeout, QR_DATA, QR_CONST, QuickrantFactory, DialogService) {
