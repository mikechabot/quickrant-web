...
<div class="container single-stream">
	<div class="rant-container shadow">
		<div class="rant-single-text-container">
			...
			<p class="rant-single-text small-bottom-margin">Either you disabled cookies, cleared your browser cache VERY recently, or something's wrong on my side (#dealwithit), either way you <b class="dark-bold">can't post without a session.</b> So enable cookies or just try again.</p>
